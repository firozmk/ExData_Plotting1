...
subMetering1 <- as.numeric(powerConsumptionData$Sub_metering_1)
subMetering2 <- as.numeric(powerConsumptionData$Sub_metering_2)
subMetering3 <- as.numeric(powerConsumptionData$Sub_metering_3)
